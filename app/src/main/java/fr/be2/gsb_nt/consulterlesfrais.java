...
public class consulterlesfrais extends MainActivity {
    ...
    private void displayListView() {
        ...
        // Utilisation de la méthode fetchFraisByDate pour filtrer les frais par date
        dataAdapter.setFilterQueryProvider(new FilterQueryProvider() {
            public Cursor runQuery(CharSequence constraint) {
                return database.fetchFraisByDate(constraint.toString());
            }
        });
    }
    }
